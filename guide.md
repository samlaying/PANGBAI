...
│                          │       他问「为什么还没做完」时，其实在意的不是进度——     │
│  本周                    │       是他今天才知道有风险。这件事[7月8日]也发生过一次。 │
│  · 和李总对接口排期      │                                                          │
│                          │       ┌──────────────────────────────────────────────┐   │
│  更早                    │       │ 💡 建议回复话术 · SUGGESTED REPLY            │   │
│  · 方案评审复盘          │       │ "王总，这块我没提前同步是我的问题。          │   │
│                          │       │  目前卡在数据标注，预计周四出初版。          │   │
│  ──────────────────────  │       │  之后我每天同步一次进度。"                   │   │
│  项目 · PROJECTS         │       └──────────────────────────────────────────────┘   │
│  📁 招聘 Agent v2  ⚠2    │       [💡建议]   [📖类似案例]   [🎭来演练一下]           │
│  📁 内部知识库改版       │                                                          │
│  [ ＋ 新建项目 ]         │  ──────────────────────────────────────────────────────  │
│                          │  ┌────────────────────────────────────────────────────┐  │
│                          │  │ 写给旁白 · TO THE COACH             ⏎ 发送 · ⇧⏎ 换行│  │
│                          │  │ 跟旁白说点什么，像写日记一样……              [发送] │  │
│                          │  └────────────────────────────────────────────────────┘  │
...
```text
✦ 左右纯净两栏 — 彻底告别横贯屏幕顶部的“三方割裂”，左侧栏与右侧内容区各自从顶到底贯穿
✦ 品牌标识归位 — 「旁白。AI 职场导师」整合在左侧边栏顶端，折叠态提供微标按钮
✦ 检索入口常驻 — ⌘K 快捷搜索内嵌于侧边栏，随时键盘或点击唤起全局浮层
✦ 新建对话幂等 — 若当前会话为空，点击「新对话」直接复用聚焦，绝不重复生成冗余 Tab
✦ 开篇一屏尽收 — 空状态引导精炼收敛（~240px），确保无论多小屏幕，指引与输入区均免滚动同屏呈现
