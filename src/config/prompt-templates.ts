...
请给我 2~3 版不同语气（正式、委婉、破局）的建议回复话术。`,
  },
  {
    ...
    title: "对接研发 / 排期博弈",
    sub: "研发砍需求、推延期时的对齐策略",
    templateText: `今天和研发团队对接了项目排期与方案，遇到了一些阻力：
- 对接对象：[例如：前端主管老李、架构师张工]
- 研发反馈：“[例如：这个需求工期不够要砍掉，或者底层架构不支持]”
- 我的核心底线：[哪些功能是本次版本绝对不能砍的核心交付物]
- 潜在妥协空间：[哪些体验细节可以放二期迭代]

请帮我用【需求范围与变更比对】技能分析谈判筹码，并给出能直接发在产研群里的专业沟通话术。`,
  },
  {
    id: "mt_plus_one",
    icon: NotebookPen,
    title: "MT+1 会议纪要与待办",
    sub: "会议结束快速沉淀结论与 Action Items",
    templateText: `刚才开完了一场关键对齐会，需要整理 MT+1 会议纪要并同步给参会人：
- 会议主题：[例如：项目方案与里程碑确认会]
- 参会人员：[例如：业务总监王总、技术总监老李、运营主管]
- 会上核心争议与最终共识：[简述共识与结论]
- 各方认领的 Action Items：[例如：老李周四给接口定义，产品周五更新 PRD]

请帮我整理为标准的 MT+1 会议纪要与待办跟进清单，并附带一条发送在群里的同步话术。`,
  },
  {
